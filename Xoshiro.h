...
/// @param _xos     Unaliased pointer to the Xoshiro128 struct.
/// @param _SEED    A 32-bit number.
////////////////////////////////////////////////////////////////
static inline void Xoshiro128_seed(Xoshiro128 *const restrict _xos, uint32_t _seed)
{
    do
    {
        for (uint8_t i = 0; i < 4; i++)
        {
            _xos->s[i] = SplitMix32(&_seed);
        }
    }
    while (!(_xos->s[0] || _xos->s[1] || _xos->s[2] || _xos->s[3]));
}
...
////////////////////////////////////////////////////////////
/// @brief      Gets the next random number (Xoshiro128**).
/// @param _xsr Unaliased pointer to the Xoshiro128 struct.
////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////
/// @brief      Xoshiro128++ version of `Xoshiro128ss_next()`.
/// @param _xsr Unaliased pointer to the Xoshiro128 struct.
///////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////
/// @brief      Gets the next random number (Xoshiro256**).
/// @param _xsr Unaliased pointer to the Xoshiro256 struct.
////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////
/// @brief      Xoshiro256++ version of `Xoshiro256ss_next()`.
...
///////////////////////////////////////////////////////////////////
/// @brief      Gets the next number within [0, _N), Xoshiro128**.
...
//////////////////////////////////////////////////////////////////////////
/// @brief      Variant of `Xoshiro128ss_nextN()` that uses Xoshiro128++.
/// @param _xsr Unaliased pointer to the Xoshiro128 structure.
//////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////
/// @brief      Gets the next number within [0, _N), Xoshiro256**.
/// @param _xsr Unaliased pointer to the Xoshiro256 structure.
///////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
/// @brief      Variant of `Xoshiro256ss_nextN()` that uses Xoshiro256++.
/// @param _xsr Unaliased pointer to the Xoshiro256 structure.
//////////////////////////////////////////////////////////////////////////
