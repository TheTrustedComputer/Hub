...
//                  1 => Base address allocation failed.
//                  2 => Memory pool allocation failed.
//                  3 => Block size is too small.
//                  4 => Mutex initialization failed.
////////////////////////////////////////////////////////////////
int MemoryPool_init(MemoryPool *const restrict _pool)
{
    ...
    {
        fprintf(stderr, "\e[1mMEMORY POOL ERROR: The block size is too small.\e[0m\n");
...
/// @param  _pool   Unaliased pointer to the memory pool.
/// @param  _SIZE   Requested block size in bytes.
/// @return         The value of `MemoryPool_alloc()`.
/////////////////////////////////////////////////////////////////
void *MemoryPool_alloc_safe(MemoryPool *const restrict _pool, const size_t _SIZE)
{
    mtx_lock(&_pool->lock);
...
/// @param  _pool   Unaliased pointer to the memory pool.
/// @return         The value of `MemoryPool_expand()`.
//////////////////////////////////////////////////////////////////
int MemoryPool_expand_safe(MemoryPool *const restrict _pool)
{
    mtx_lock(&_pool->lock);
